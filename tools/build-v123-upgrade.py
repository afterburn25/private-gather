...
FILES = [
    ...
    'app/Http/Middleware/EnsureDiscoverableConnectionTarget.php',
    'app/Http/Middleware/EnsureJoinableMemberGroup.php',
    ...
    'app/Http/Controllers/Tenant/GrowthCommerceController.php',
    'app/Http/Controllers/Tenant/MembershipManagementController.php',
    'app/Http/Controllers/Tenant/OrganizationController.php',
    'app/Models/User.php',
    'app/Models/Profile.php',
    'app/Models/ProfilePartnerInvite.php',
    'app/Models/CommunityPost.php',
    'app/Models/CommunityGroupInvite.php',
    'app/Models/CommunityPollVote.php',
    ...
    'resources/views/tenant/manage/growth.blade.php',
    'resources/views/tenant/manage/growth-members.blade.php',
